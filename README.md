This project is a basic web-based quiz built using HTML, CSS, and JavaScript. The application allows users to test their knowledge on various topics through a series of multiple-choice questions.<br>
